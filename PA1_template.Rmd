...
original numbers, are reasonable, as the holes, which were labeled NA|0, have been filled with new values from the 
...
```{r}
    ...
    ggplot(data=activity, aes(x=date, y=steps)) + 
        ...
        geom_line(data=maxStepsPerInterval, 
                  aes(x=date, y=mSteps, color="brightred", lwd="2"), 
